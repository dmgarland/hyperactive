      ...
      def locate_globalize_path(template_path, use_full_path)
        ...
        if use_full_path
          ...
          if template_extension
            ...
            template_extension = @finder.pick_template_extension(template_path).to_s #pick_template_extension(template_path).to_s
            template_file_name = @finder.pick_template(template_path, template_extension) #full_template_path(template_path, template_extension)
          end
        else
