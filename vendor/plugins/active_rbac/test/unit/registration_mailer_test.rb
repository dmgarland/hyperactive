...
class RegistrationMailerTest < Test::Unit::TestCase
  ...
  def test_confirm_registration
    @expected.from    = ActiveRbac.mailer_from
    @expected.subject = ActiveRbac.mailer_subject_confirm_registration
  ...
  def test_lost_password
    @expected.from    = ActiveRbac.mailer_from
    @expected.subject = ActiveRbac.mailer_subject_lost_password
    @expected.to      = 'root@localhost'
