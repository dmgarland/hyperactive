ActionController::Routing::Routes.draw do |map|
  ...
  map.mission_statement 'mission_statement', :controller => 'page', :action => 'show', :title => 'Mission Statement'
  map.contact_us 'contact_us', :controller => 'page', :action => 'show', :title => 'Contact Us'
  map.get_involved 'get_involved', :controller => 'page', :action => 'show', :title => 'Get Involved'
  map.help 'help', :controller => 'page', :action => 'show', :title => 'Help'
  map.editorial_guidelines 'editorial_guidelines', :controller => 'page', :action => 'show', :title => 'Editorial Guidelines'
