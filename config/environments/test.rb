...
config.plugins = ["tiny_mce", "ssl_requirement", "active_rbac",  "engines", "has_many_polymorphs", "acts_as_ferret", "backgroundrb", "ez-where", "file_column", "paginating_find", "resource_feeder", "simply_helpful", "sub_list", "globalize", "simple_captcha", "white_list", "sanitize_params", "hyperactive"]
