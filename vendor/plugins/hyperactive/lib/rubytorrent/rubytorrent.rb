...
load_path = "#{RAILS_ROOT}/vendor/plugins/hyperactive/lib/rubytorrent"

require "#{load_path}/rubytorrent/util"
require "#{load_path}/rubytorrent/bencoding"
require "#{load_path}/rubytorrent/metainfo"
require "#{load_path}/rubytorrent/tracker"
require "#{load_path}/rubytorrent/package"
require "#{load_path}/rubytorrent/server"
