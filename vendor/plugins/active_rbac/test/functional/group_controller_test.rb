...
require 'active_rbac_mixins/exceptions'
#require 'active_rbac/group_controller'

# Re-raise errors caught by the controller.
#class ActiveRbac::GroupController; def rescue_action(e) raise e end; end

class ActiveRbac::GroupControllerTest < ActionController::TestCase
  ...
  tests ActiveRbac::GroupController
...
#  end
  ...
  def test_should_display_form_and_errors_on_create_POST_with_invalid_title
    ...
    for char in invalid_chars
      ...
      assert_match /Title must not contain invalid characters/, @response.body
  ...
  def test_should_display_confirmation_form_on_delete_GET_with_valid_group_id
    get :delete, :id => groups(:heroes_group).id
