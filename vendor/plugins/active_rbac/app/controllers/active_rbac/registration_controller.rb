...
class ActiveRbac::RegistrationController < ActiveRbac::ComponentController
  ...
  def register
    if request.method != :post
      ...
      if @user.save then
        ...
        render :template => 'active_rbac/registration/register_success'
        return
      end
    end
  ...
  def confirm
    ...
    render :template => 'active_rbac/registration/confirm_failure'
  end
  ...
  def lostpassword
    ...
    if request.method == :post
      ...
      render :template => 'active_rbac/registration/lostpassword_success'
    end
  rescue ActiveRecord::RecordNotFound
